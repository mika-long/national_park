...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_svelteplot: string;
	...
	export const npm_package_dependencies_tw_animate_css: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_svelteplot: string;
		...
		SHELL: string;
		TERM: string;
		npm_package_dependencies_tw_animate_css: string;

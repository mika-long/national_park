...
function Loader_circle($$anchor, $$props) {
  ...
  add_svelte_meta(
    () => (
      ...
      *
      */
      Icon_default(node, spread_props({ name: "loader-circle" }, () => props, {
        get iconNode() {
          return iconNode;
        },
        children: wrap_snippet(Loader_circle, ($$anchor2, $$slotProps) => {
          ...
          add_svelte_meta(() => snippet(node_1, () => $$props.children ?? noop), "render", Loader_circle, 62, 2);
...
if (import.meta.hot) {
  Loader_circle = hmr(Loader_circle);
  import.meta.hot.accept((module) => {
    Loader_circle[HMR].update(module.default);
  });
}
...
//# sourceMappingURL=@lucide_svelte_icons_loader-2.js.map
